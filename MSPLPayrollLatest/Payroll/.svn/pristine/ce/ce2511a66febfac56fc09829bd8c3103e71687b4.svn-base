        ...
        this.wave = function ()
        {
            ...
            for (var i=0,len=this.coords.length; i<len; i+=1) {
                ...
                if (this.coords[i].object.rgraph_3d_side_face) {
                    ...
                    var parent = this.coords[i].object.rgraph_3d_side_face[0].parentNode;
                    
                    parent.removeChild(this.coords[i].object.rgraph_3d_side_face[0]);
                    parent.removeChild(this.coords[i].object.rgraph_3d_side_face[1]);
                    
                    parent.removeChild(this.coords[i].object.rgraph_3d_top_face[0]);
                    parent.removeChild(this.coords[i].object.rgraph_3d_top_face[1]);
                }
            }
                ...
                for (var i=0,len=obj.coords.length; i<len; i+=1) {
                    if (frame > opt.startFrames[i]) {
                        ...
                        if (prop.variant === '3d') {
                            ...
                            // Remove the 3D sides to the bar
                            var parent = obj.coords[i].object.rgraph_3d_side_face[0].parentNode;
        
                            if (parent) parent.removeChild(obj.coords[i].object.rgraph_3d_side_face[0]);
                            if (parent) parent.removeChild(obj.coords[i].object.rgraph_3d_side_face[1]);
                            
                            var parent = obj.coords[i].object.rgraph_3d_top_face[0].parentNode;
                            if (parent) parent.removeChild(obj.coords[i].object.rgraph_3d_top_face[0]);
                            if (parent) parent.removeChild(obj.coords[i].object.rgraph_3d_top_face[1]);
                        ...
                        if (prop.variant === '3d') {
                            ...
                            obj.drawSide3dFace({
                                ...
                                value: obj.coords[i].object.getAttribute('data-value')
                            });
