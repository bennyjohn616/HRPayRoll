    ...
    RGraph.Bar = function (conf)
    {
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.colors': ['red', '#0f0', 'blue', 'pink', 'orange', 'cyan', 'black', 'green', 'magenta', 'Olive', 'DarkBlue', 'LightBlue', 'Yellow', 'grey', 'Silver', 'Lime', 'charcoal', 'Iceberg', 'celeste', 'teal', 'cream', 'peach','beer','sand','brass','wood','rust','sedona','coral','chestnut','magenta','indigo','lilac'],
