...
var ModalPopups = {
    ...
    Close: function (id) {
        ...
        try {
            ...
            if (document.getElementById(id) != null) {
                document.body.removeChild(document.getElementById(id + "_background"));
                document.body.removeChild(document.getElementById(id + "_popup"));
                document.body.removeChild(document.getElementById(id + "_shadow"));
            }
        }
    },
    ...
    _createAllLayers: function (id, title, message, parameters) {
        ...
        oPopupTitle.innerHTML = "<table cellpadding='0' cellspacing='0' style='border: 0px;' height='100%'>" +
    ...
    _styleAllLayers: function (id, parameters, allLayers) {
        ...
        var cssPopup = "display:inline; position:absolute; z-index: " + (zIndex + 1) + "; background-color:#C7D6E9; color:black; border:solid 0px " + parameters.borderColor + "; padding:1px;"; // background-color:#EEF1F2
        ...
        cssPopupBody += " background-color:" + parameters.titleBackColor + ";";
        ...
        cssPopupTitle += " width:" + (parameters.width - 3) + "px;"; // Sub 10px for; padding-left+right: 5px; // Modified by : Shankar
        cssPopupBody += " width:" + (parameters.width - 3) + "px;"; // Sub 10px for-left+right; padding: 5px;
        cssPopupFooter += " width:" + (parameters.width - 3) + "px;"; // Sub 10px for-left+right; padding: 5px;
        ...
        objXml.onreadystatechange = function () {
            if (objXml.readyState == 4) {
                ...
                var html = "<div style='overflow-y: scroll; position:absolute; " +
                    "top:0px; left:5px; height:" + (parameters.height - 65) + "px; " +
