...
$dyanmicEntity = {
    ...
    LoadEntityModelDrop: function () {
        ...
        $dyanmicEntity.LoadEntityModel({ id: 'sltEntityModel' });
    ...
    renderFieldGrid: function (context, tableprop) {
        ...
        $("#dvTitle").html('');
        $("#dvTitle").html('<h4>' + $dyanmicEntity.selectedEntityModelname + '</h4>');
    ...
    LoadGridData: function () {
        ...
        $.ajax({
            type: 'POST',
            url: $app.baseUrl + "Entity/GetEntityList",
            contentType: "application/json; charset=utf-8",
    ...
    save: function (context) {
        ...
        $.ajax({
            url: $app.baseUrl + "Entity/SaveEntity",
    ...
    CopyDynamicGroupEntity: function (data) {

        $.ajax({
            url: $app.baseUrl + "Entity/CopyDynamicGroupEntity",
            data: JSON.stringify({ id: data.Id, entityModelId: $dyanmicEntity.selectedEntityModelId }),
            dataType: "json",
            contentType: "application/json",
            type: "POST",
    ...
    copyEntity: function (context) {

        $.ajax({
            type: 'POST',
            url: $app.baseUrl + "Entity/CopyEntity",
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify({ id: context.Id, entityModelId: context.EntityModelId }),
            dataType: "json",
            success: function (jsonResult) {
