...
namespace PayrollBO
{
    public class EntityBehaviorList : List<EntityBehavior>
    {
        ...
        /// </summary>
        /// <param name="id"></param>
        public EntityBehaviorList(Guid entityId, Guid entityModelId)
        {
            this.EntityModelId = entityModelId;
            this.EntityId = entityId;
            EntityBehavior attributeModelBehavior = new EntityBehavior();
            DataTable dtValue = attributeModelBehavior.GetTableValues(Guid.Empty, entityModelId, entityId);
            if (dtValue.Rows.Count > 0)
            {
                for (int rowcount = 0; rowcount < dtValue.Rows.Count; rowcount++)
                {
                    EntityBehavior attributeModelBehaviorTemp = new EntityBehavior();
        ...
        public void AddNew(EntityBehavior attributeModelBehavior)
        {
        ...
        /// </summary>
        /// <param name="attributeModelBehavior"></param>
        public void DeleteExist(EntityBehavior attributeModelBehavior)
        {
        ...
        public void Validate(string input, EntityBehaviorList lstCollection, string lhs, ref string error, out string values)
        {
            values = string.Empty;
