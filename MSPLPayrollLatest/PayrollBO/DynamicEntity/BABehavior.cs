...
namespace PayrollBO
{
    ...
    /// <summary>
    /// To handle the BABehavior
    /// </summary>
    public class BABehavior
    {
        ...
        public BABehavior(Guid attrubuteModelid, Guid entityModelId, Guid entityId)
        {
            ...
            if (dtValue.Rows.Count > 0)
            {
                ...
                this.CompType = Convert.ToString(dtValue.Rows[0]["CompType"]);
        ...
        public bool Save()
        {
            SqlCommand sqlCommand = new SqlCommand("BABehavior_Save");
            ...
            sqlCommand.Parameters.AddWithValue("@CompType", this.CompType);
        ...
        public bool Delete()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("BABehavior_Delete");
            sqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        protected internal DataTable GetTableValues(Guid attrubuteModelid, Guid entityModelId, Guid entityId)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("BABehavior_Select");
            sqlCommand.CommandType = CommandType.StoredProcedure;
