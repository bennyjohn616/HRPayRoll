// -----------------------------------------------------------------------
// <copyright file="Grade.cs" company="Microsoft">
...
namespace PayrollBO
{
    ...
    public class Grade
    {
        ...
        /// </summary>
        /// <param name="id"></param>
        public Grade(Guid id,int companyId)
        {
            this.Id = id;
        ...
        public bool Save()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("Grade_Save");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@Id", this.Id);
            sqlCommand.Parameters.AddWithValue("@CompanyId", this.CompanyId);
            sqlCommand.Parameters.AddWithValue("@GradeName", this.GradeName);
        ...
        public bool Delete()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("Grade_Delete");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@Id", this.Id);
            sqlCommand.Parameters.AddWithValue("@ModifiedBy", this.ModifiedBy);
            DBOperation dbOperation = new DBOperation();
        ...
        protected internal DataTable GetTableValues(int companyId, Guid id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("Grade_Select");
            sqlCommand.CommandType = CommandType.StoredProcedure;
