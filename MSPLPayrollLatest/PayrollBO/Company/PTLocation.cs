// -----------------------------------------------------------------------
// <copyright file="PTLocation.cs" company="Microsoft">
...
namespace PayrollBO
{
    ...
    public class PTLocation
    {
        ...
        /// </summary>
        /// <param name="id"></param>
        public PTLocation(Guid id, int companyId)
        {
            this.Id = id;
        ...
        public bool Save()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("PTLocation_Save");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@Id", this.Id);
            sqlCommand.Parameters.AddWithValue("@CompanyId", this.CompanyId);
            sqlCommand.Parameters.AddWithValue("@PTLocationName", this.PTLocationName);
        ...
        /// <summary>
        /// Delete the PTLocation
        /// </summary>
        /// <returns></returns>
        public bool Delete()
        {

            SqlCommand sqlCommand = new SqlCommand("PTLocation_Delete");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@Id", this.Id);
            sqlCommand.Parameters.AddWithValue("@ModifiedBy", this.ModifiedBy);
            DBOperation dbOperation = new DBOperation();
        ...
        protected internal DataTable GetTableValues(int companyId, Guid id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("PTLocation_Select");
            sqlCommand.CommandType = CommandType.StoredProcedure;
