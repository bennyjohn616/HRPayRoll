// -----------------------------------------------------------------------
// <copyright file="Department.cs" company="Microsoft">
...
namespace PayrollBO
{
    ...
    public class Department
    {
        ...
        /// </summary>
        /// <param name="id"></param>
        public Department(Guid id, int companyId)
        {
            this.Id = id;
        ...
        public bool Save()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("Department_Save");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@Id", this.Id);
            sqlCommand.Parameters.AddWithValue("@CompanyId", this.CompanyId);
            sqlCommand.Parameters.AddWithValue("@DepartmentName", this.DepartmentName);
        ...
        public bool Delete()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("Department_Delete");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@Id", this.Id);
            sqlCommand.Parameters.AddWithValue("@ModifiedBy", this.ModifiedBy);
            DBOperation dbOperation = new DBOperation();
        ...
        protected internal DataTable GetTableValues(int companyId, Guid id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("Department_Select");
            sqlCommand.CommandType = CommandType.StoredProcedure;
