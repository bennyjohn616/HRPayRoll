// -----------------------------------------------------------------------
// <copyright file="HRComponent.cs" company="Microsoft">
...
namespace PayrollBO
{
    ...
    public class HRComponent
    {
        ...
        /// </summary>
        /// <param name="id"></param>
        public HRComponent(Guid id, int companyId)
        {
            this.Id = id;
            ...
            if (dtValue.Rows.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(dtValue.Rows[0]["CreatedOn"])))
                    this.CretedOn = Convert.ToDateTime(dtValue.Rows[0]["CreatedOn"]);
        ...
        public bool Save()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("HRComponent_Save");
        ...
        public bool Delete()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("HRComponent_Delete");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@Id", this.Id);
            sqlCommand.Parameters.AddWithValue("@ModifiedBy", this.ModifiedBy);
            DBOperation dbOperation = new DBOperation();
        ...
        protected internal DataTable GetTableValues(int companyId, Guid id)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("HRComponent_Select");
            sqlCommand.CommandType = CommandType.StoredProcedure;
