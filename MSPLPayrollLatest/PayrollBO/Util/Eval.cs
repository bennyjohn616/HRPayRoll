...
namespace PayrollBO
{
    ...
    public class Eval
    {
        ...
        public string Execute(string expression)
        {
            ...
            {
                return ExecuteTokens(TokenizeExpression(expression)).ToString();
            }
        }
            ...
            while (!parser.EndOfText)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        result = EvaluateSymbol(temp, symbolPos,expression);
                    }
        ...
        protected double EvaluateParameter(TextParser parser, int paramStart)
        {
            try
            {
                ...
                return double.Parse(Execute(expression));
            }
        ...
        /// <returns></returns>
        protected double EvaluateSymbol(string name, int pos,string expression)
        {
            double result = default(double);
        ...
        public static decimal LimitNegativeValues(decimal value)
        {
            if (value < 0)
            {
                return 0;
